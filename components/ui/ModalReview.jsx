                    ...
                    <div className="flex-1 p-6">       
                        <div class="flex-center space-x-3 mb-5">
                            {Array(5).fill('star').map((_, idx) => (
                                <svg className={`w-10 h-10 ${idx + 1 <= star ? 'text-yellow-400' : 'text-gray-400 dark:text-gray-600' } cursor-pointer`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" onClick={() => setStar(idx + 1)}>
